...
Structured creative education for aspiring artists and creator upgraders. Project-first curriculum, Dew Monday editorial voice, built with Remotion for video delivery.
...
- - **Project-first**  every lesson ends in something shareable
  - - **Community layer**  learners share, get feedback, and stay motivated
    - - **Dew Monday voice**  editorial, warm, creator-native
      ...
      | Segment | Profile |
      |---|---|
      | Beginner Artists | Age 1628, wants to develop a real skill, no formal training |
      ...
      **V3:** Live workshops, AI critique tool, Mobile app (iOS + Android)
      ...
      | Payments | Stripe |
      | Video production | Remotion (programmatic trailers + lesson intros) |

      ---

      ## Key Questions to Answer

      - [ ] What is the minimum viable curriculum (1 track, 5 lessons)?
      - [ ] - [ ] Free trial vs. freemium vs. paid upfront?
      - [ ] - [ ] How does this connect to Creator Hub content strategy?
